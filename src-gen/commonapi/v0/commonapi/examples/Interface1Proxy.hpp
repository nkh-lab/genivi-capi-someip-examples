...
public:
     ...
     * will be set.
     */
    virtual void setUInt32(uint32_t _value, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr);
    /**
...
template <typename ... _AttributeExtensions>
void Interface1Proxy<_AttributeExtensions...>::setUInt32(uint32_t _value, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info) {
...
template <typename ... _AttributeExtensions>
std::future<void> Interface1Proxy<_AttributeExtensions...>::getCompletionFuture() {
